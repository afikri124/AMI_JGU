                    ...
                    <div class="col-12 pt-3 pt-md-0">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class=" col-md-3">
                                        <select id="select_gender" class="select2 form-select"
                                ...
                                <div class="col-sm-12 fv-plugins-icon-container">
                                    ...
                                    <div class="input-group input-group-merge has-validation">
                                        <select class="form-select @error('gender') is-invalid @enderror select2-modal"
                                            ...
                                            <option value="F" {{ ("F"==old('gender') ? "selected": "") }}>Female
                                            </option>
                                        </select>
                                        @error('gender')
                                        <span class="invalid-feedback" role="alert">
                    ...
                    columns: [{
                        ...
                        },
                        {
                            render: function (data, type, row, meta) {
                                ...
                                if (row.no_phone) {
                                    html += `<br><a href="tel:` + row.no_phone +
                        ...
                        {
                            render: function (data, type, row, meta) {
                                var html = "<code><span title='" + row.username + "'>" + row
                                    .username +
                                    "</span></code>";
                                return html;
                            },
                        ...
                        },
                        {
                            render: function (data, type, row, meta) {
                                if (row.gender != null) {
                                    return "<span title='" + row.gender + "'>" + row.gender +
                                        "</span>";
                                }
