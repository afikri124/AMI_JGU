...
<body style="margin: 20px auto;">
    ...
    <table class="main-bg-light text-center top-0" align="center" border="0" cellpadding="0" cellspacing="0"
        ...
        <tbody>
            ...
            <p style="text-align: justify;">The auditee has uploaded the documents required for auditing. Please check whether the documents uploaded by the auditee through the <a href="{{ url('/dashboard') }}">sistem.</a> are appropriate or not.</a></p>
                <td style="font-size: 10pt;">
