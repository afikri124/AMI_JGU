    ...
    <table class="main-bg-light text-center top-0" align="center" border="0" cellpadding="0" cellspacing="0"
        ...
        <tbody>
                ...
                <td style="font-size: 10pt;">
                    <p style="text-align: justify;">Dear Mr/Mrs, You have a new audit plan. Here are the details:</p><br>
                </td>
            </tr>
                <tR class="pad-left-right-space">
                <td  ><p style="text-align: justify;">Auditee <b><b>:</b> {{ $data['auditee_id'] }}</b></p></td>
            </tR>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Auditor <b><b>:</b> {{ $data['auditor_id'] }}</b></p></td>
            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Date Start <b><b>:</b> {{ $data['date_start'] }}</b></p></td>
            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Date End  <b><b>:</b> {{ $data['date_end'] }}</b></p></td>
            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Department <b><b>:</b> {{ $data['department_id'] }}</b></p></td>
            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Location <b><b>:</b> {{ $data['location_id'] }}</b></p></td>
                <td ></td>
            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Type Audit <b>:</b><b> {{ $data['type_audit'] }}</b></p></td>

            </tr>
            <tr class="pad-left-right-space">
                <td ><p style="text-align: justify;">Periode <b>:</b><b> {{ $data['periode'] }}</b></p></td>
            </tr>
            <tr>
                <td style="font-size: 10pt;">
