...
<body style="margin: 20px auto;">
    ...
    <table class="main-bg-light text-center top-0" align="center" border="0" cellpadding="0" cellspacing="0"
        ...
        <tbody>
            ...
            <p style="text-align: justify;">The audit standard has been set by the Admin. Please check whether the <a href="{{ url('/dashboard') }}">standards</a>  set by the admin is appropriate or not.</p>
                <td style="font-size: 10pt;">
