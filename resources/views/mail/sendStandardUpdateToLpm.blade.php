            ...
            <tr>
                ...
                <tr>
                    <td style="font-size: 10pt;">
                        <p style="text-align: justify;">Dear Mr/Mrs, The Audit Standards Have Been Updated By Admin.</p><br>
                    </td>
                </tr>
            <p style="text-align: justify;">Audit standards have been updated by Admin. Please check again whether the <a href="{{ url('/lpm') }}">standards</a> are truly appropriate or not for field audits.</p>
                <td style="font-size: 10pt;">
