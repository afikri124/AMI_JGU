...
@foreach ($standardCriterias as $criteria)
    ...
    @if ($hasObsInCriteria)
    <!-- Mulai div page-break untuk setiap kriteria -->
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="70%" valign="top">KETUA : {{ $auditors->first()->auditor->name }}
                    <br>ANGGOTA : @if($auditors->count() > 1) {{ $auditors->get(1)->auditor->name }} @endif</td>
            </tr>
            <tr>
    ...
    <!-- Tutup div page-break untuk setiap kriteria -->
    @endif
@endforeach
...
@foreach ($standardCriterias as $criteria)
    @php
    // Cek jika ada indikator dengan kategori KS MAYOR
    $hasMayorInCriteria = false;
    @endphp
    ...
    @if ($hasMayorInCriteria)
    <!-- Mulai div page-break untuk setiap kriteria dengan kategori KTS MAYOR -->
    <div class="page-break">
        <table width="100%">
            <tr>
                <td colspan="1" rowspan="2" class="center">
            ...
            <tr>
                ...
                <td width="70%" valign="top">
                    KETUA : {{ $auditors->first()->auditor->name }}
    ...
    <!-- Tutup div page-break untuk setiap kriteria dengan kategori KTS MAYOR -->
    @endif
@endforeach
...
@foreach ($standardCriterias as $criteria)
    ...
    @if ($hasKSInCriteria)
    <!-- Mulai div page-break untuk setiap kriteria dengan kategori KS -->
    <div class="page-break">
        <table width="100%">
            <tr>
                <td colspan="1" rowspan="2" class="center">
    ...
    <!-- Tutup div page-break untuk setiap kriteria dengan kategori KS -->
    @endif
@endforeach