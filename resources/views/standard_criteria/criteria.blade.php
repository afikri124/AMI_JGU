                    ...
                    <div class="offcanvas-body my-auto mx-0 flex-grow-1">
                        <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework"
                            ...
                            <div class="col-sm-12 fv-plugins-icon-container">
                                ...
                                <div class="input-group input-group-merge has-validation">
                                    <select
                                        class="form-select @error('standard_category_id') is-invalid @enderror  input-sm select2-modal"
                ...
                },
                {
                    render: function (data, type, row, meta) {
                        ...
                        if (row.category && row.category.id) {
                            var html =
                                `<a class="text-info" title="${row.category.description}" href="">${row.category.description}</a>`;
                            return html;
                        } else {
                ...
                },
                {
                    render: function (data, type, row, meta) {
                        ...
                        var html =
                            ...
                            <a class="badge bg-danger badge-icon" title="Delete" style="cursor:pointer" onclick="DeleteId(\'` +
                            row.id + `\',\'` + row.title +
